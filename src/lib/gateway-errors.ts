...
const DEFAULT_GATEWAY_ERROR_DEFINITIONS: GatewayErrorDefinition[] = [
  ...
  { code: "provider_offline", httpStatus: 503, publicMessage: "The selected model is temporarily unavailable. Please retry later.", retryable: true },
  { code: "provider_model_inactive", httpStatus: 503, publicMessage: "The selected model is temporarily unavailable. Please retry later.", retryable: true },
  { code: "provider_credential_missing", httpStatus: 503, publicMessage: "The service is temporarily unavailable for this model. Please retry later.", retryable: true },
  { code: "provider_credential_incomplete", httpStatus: 503, publicMessage: "The service is temporarily unavailable for this model. Please retry later.", retryable: true },
  { code: "provider_credential_unusable", httpStatus: 503, publicMessage: "The service is temporarily unavailable for this model. Please retry later.", retryable: true },
  { code: "provider_credential_legacy", httpStatus: 503, publicMessage: "The service is temporarily unavailable for this model. Please retry later.", retryable: true },
  { code: "provider_credential_unavailable", httpStatus: 503, publicMessage: "The service is temporarily unavailable for this model. Please retry later.", retryable: true },
  { code: "provider_credential_decrypt_failed", httpStatus: 503, publicMessage: "The service is temporarily unavailable for this model. Please retry later.", retryable: true },
  { code: "model_billing_not_configured", httpStatus: 503, publicMessage: "The selected model is temporarily unavailable. Please retry later.", retryable: false },
  { code: "provider_pricing_not_configured", httpStatus: 503, publicMessage: "The selected model is temporarily unavailable. Please retry later.", retryable: false },
  { code: "database_operation_failed", httpStatus: 503, publicMessage: "The service could not access required internal records. Please retry later.", retryable: true },
  { code: "billing_resolution_failed", httpStatus: 503, publicMessage: "The selected model pricing could not be evaluated. Please retry later.", retryable: true },
  { code: "request_record_write_failed", httpStatus: 503, publicMessage: "The request could not be recorded internally. Please retry later.", retryable: true },
  { code: "api_key_touch_failed", httpStatus: 503, publicMessage: "The request was accepted but internal key tracking failed. Please retry later.", retryable: true },
  { code: "queue_unavailable", httpStatus: 503, publicMessage: "The internal job queue is temporarily unavailable. Please retry later.", retryable: true },
  ...
  { code: "video_output_missing", httpStatus: 502, publicMessage: "The generation provider returned an incomplete result. Please retry shortly.", retryable: true },
