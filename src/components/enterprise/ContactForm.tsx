      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-12 lg:flex-row lg:justify-between">
          <FadeIn className="flex flex-col gap-4 lg:w-96 lg:shrink-0 lg:pt-2">
            <h2 className="text-2xl font-bold leading-none tracking-tight text-[#1C1917] md:text-4xl lg:text-5xl">
              Get in touch
            </h2>
          ...
          <div className="max-w-xl min-w-0 flex-1">
            {submitted ? (
              <FadeIn>
                <div className="rounded-lg border border-black/10 bg-[#f5f5f3] p-6">
              ...
              <FadeIn delay={0.1}>
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        name="country"
                        defaultValue=""
                        className="h-10 w-full rounded-lg border border-black/10 bg-white px-3 text-sm text-[#1C1917] outline-none transition-colors focus:border-black/20"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="h-10 w-full rounded-lg border border-black/10 bg-transparent px-3 py-1 text-sm text-[#1C1917] outline-none transition-colors placeholder:text-black/35 focus:border-black/20"
                      />
                    </div>
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <textarea
                        ...
                        className="min-h-[120px] w-full rounded-lg border border-black/10 bg-white px-3 py-2 text-sm text-[#1C1917] outline-none transition-colors placeholder:text-black/35 focus:border-black/20"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="mt-2 flex h-11 w-full cursor-pointer items-center justify-center rounded-lg bg-[#1C1917] px-4 py-2 text-sm font-bold text-white transition-colors duration-150 hover:bg-[#1C1917]/80"
                  >
                    Submit
                  </button>
                </form>
