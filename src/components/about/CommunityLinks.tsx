            ...
            {communityLinks.map((link, i) => (
              <FadeIn key={link.label} delay={i * 0.1}>
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-black/10 px-5 py-2.5 text-sm text-black/55 transition-colors hover:border-black/20 hover:text-[#1C1917]"
                >
                  {link.label}
                </Link>
              </FadeIn>
        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          <p className="text-sm text-black/55">
            <Link
              ...
              className="text-black/60 transition-colors hover:text-[#1C1917]"
            >
