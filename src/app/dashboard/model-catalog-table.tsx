...
export function ModelCatalogTable({
  ...
  if (rows.length === 0) {
    return (
      <div className="rounded-sm border border-dashed border-black/12 bg-[#faf9f6] px-4 py-8 text-sm text-black/50">
            ...
            return (
              <Fragment key={row.id}>
                <tr className="bg-[#faf9f6]">
                  <td className="rounded-l-[14px] px-3 py-2.5">
                  ...
                  <td className="px-3 py-2.5 text-sm text-black/70">
                    <span
                      className={cn(
                        "inline-flex rounded-sm px-2 py-1 text-[11px]",
                  ...
                  <td className="rounded-r-[14px] px-3 py-2.5 text-right">
                    <button
                      ...
                      className="inline-flex h-8 items-center gap-2 rounded-sm border border-black/10 bg-white px-3 text-xs text-black/70 transition-colors hover:bg-black/[0.03]"
                    >
                ...
                {open ? (
                  <tr>
                    <td colSpan={5} className="px-0 pb-2 pt-0">
                      <div className="rounded-[14px] border border-black/10 bg-white px-4 py-4">
