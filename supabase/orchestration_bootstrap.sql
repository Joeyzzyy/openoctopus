...
create table if not exists public.inference_requests (
  ...
  estimated_customer_charge numeric(12,6) not null default 0,
  actual_customer_charge numeric(12,6) not null default 0,
  estimated_provider_cost numeric(12,6) not null default 0,
  actual_provider_cost numeric(12,6) not null default 0,
  estimated_profit numeric(12,6) not null default 0,
  actual_profit numeric(12,6) not null default 0,
